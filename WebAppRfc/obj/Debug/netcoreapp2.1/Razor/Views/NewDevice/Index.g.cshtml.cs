#pragma checksum "C:\Users\Evgen\Dropbox\VisualStudioProjects\Projects\WebAppRfc\WebAppRfc\Views\NewDevice\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e80b7886faa1d53b3730a71bac8c53f8e3cc3c0f"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e80b7886faa1d53b3730a71bac8c53f8e3cc3c0f", @"/Views/NewDevice/Index.cshtml")]
...
#line default
#line hidden
            BeginContext(50, 1236, true);
            WriteLiteral(@"
<div class=""panel panel-primary"" style=""display:inline-block"">
    <h2 class=""panel-heading"">Adding new device</h2>

    <div id=""app_controller_addNewDev"" ng-controller=""addNewDev as newDev"" ng-init=""newDev.GetRooms()"" class=""panel-body"">
        <div>
        ...
        <div ng-show=""newDev.selectedType.id == 1 || newDEv.selectedType.id == 2"">
            <input class=""btn-primary"" type=""button"" ng-click=""newDev.BindClicked()"" value=""Send Bind""/>
        </div>

        <div>
            <input type=""button"" value=""Add"" ng-click=""newDev");
            WriteLiteral(".AddClicked()\" />\r\n        </div>\r\n        <div class=\"center-block\"> \r\n            <label  class=\"bg-success text-center\"  ng-model=\"newDev.Status\">{{newDev.Status}}</label>\r\n        </div>\r\n    </div>\r\n</div>\r\n");
            EndContext();
        }
